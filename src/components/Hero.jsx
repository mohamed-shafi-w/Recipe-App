  ...
  return (
    <div className='hero-container'>
        <div className="hero-text">
              ...
              <h1>Discover great recipes for all occasions...</h1>
              <p>Are you ready to excite your taste buds?<br/> Dive into our extensive recipe collection to find your next culinary experience.</p>
